...
-- run_once({ "unclutter -root", "compton", "xwinwrap -ov -ni -sp -st -fs -- /usr/lib/xscreensaver/pixelcity --root -window-id WID" }) -- entries must be comma-separated
-- run_once({ "compton" }) -- entries must be comma-separated
-- }}}
...
--awful.util.tagnames = { "main", "aux", "www", "prog", "files", "gimp", "coms", "games" }
awful.util.tagnames = { "❶","❷","❸","❹","❺","❻","❼","❽","❾"}
...
--    if c.floating and not awful.rules.matches(c, { rule_any = { class = { "Audacious", "exefile.exe"} } } ) then

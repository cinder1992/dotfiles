...
beautiful.init("~/.config/awesome/themes/neil/theme.lua")
...
tags = {
        names = { "main", "aux", "www", "prog", "files", "gimp", "coms", "games"},
        layout = { layouts[1], layouts[1],layouts[2], layouts[3], layouts[2], layouts[1], layouts[3], layouts[1] }
}
